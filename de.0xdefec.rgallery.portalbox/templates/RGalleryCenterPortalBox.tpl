		...
		<div class="border" id="box{$boxID}">
			<div class="containerHead">
				<div class="containerIcon">
			    	<a href="javascript: void(0)" onclick="openList('rgallerybox', true)">
                	<img src="{@RELATIVE_WCF_DIR}icon/minusS.png" id="rgalleryboxImage" alt="" /></a>
            	</div>
				<div class="containerContent"><span>{lang}de.0xdefec.rgallery.portalbox.title{/lang}</span>
				</div>
           	</div>
			<div class="container-1" id="rgallerybox">
			    <div class="containerContent">
			    	{if $items > 0}
						<ul class="gallery-thumbs">
						{foreach from=$centerboxdata item=value key=key}
		...
		<script type="text/javascript">
		//<![CDATA[
		initList('rgallerybox', {@$item.Status});
		//]]>
		</script>